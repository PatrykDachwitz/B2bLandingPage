...
*/
    ...
    | convenção "atributo.regra" para nomear as linhas. Isso facilita a especificação de
    | uma linha de idioma personalizada para uma determinada regra de atributo.
    |
    */
    ...
    | Isso ajuda a tornar a nossa mensagem mais expressiva.
    |
    */
