...
return [
    ...
    'after' => 'Το πεδίο :attribute πρέπει να είναι μια ημερομηνία μετά το :date.',
    'after_or_equal' => 'Το πεδίο :attribute πρέπει να είναι μια ημερομηνία μετά ή ίση με το :date.',
    'alpha' => 'Το πεδίο :attribute πρέπει να περιέχει μόνο γράμματα.',
    'alpha_dash' => 'Το πεδίο :attribute πρέπει να περιέχει μόνο γράμματα, αριθμούς, παύλες και υπογραμμίσεις.',
    ...
    'ascii' => 'Το πεδίο :attribute πρέπει να περιέχει μόνο χαρακτήρες ASCII και σύμβολα μονής μπατ.',
    'before' => 'Το πεδίο :attribute πρέπει να είναι μια ημερομηνία πριν από το :date.',
    'before_or_equal' => 'Το πεδίο :attribute πρέπει να είναι μια ημερομηνία πριν ή ίση με το :date.',
    'between' => [
    ...
    'enum' => 'Το επιλεγμένο :attribute είναι μη έγκυρο.',
    'exists' => 'Το επιλεγμένο :attribute είναι μη έγκυρο.',
    'extensions' => 'Το πεδίο :attribute πρέπει να έχει μια από τις εξής επεκτάσεις: :values.',
    ...
    'lt' => [
        ...
        'file' => 'Το πεδίο :attribute πρέπει να είναι λιγότερο από :value κιλομπάιτ.',
        'numeric' => 'Το πεδίο :attribute πρέπει να είναι λιγότερο από :value.',
        'string' => 'Το πεδίο :attribute πρέπει να είναι λιγότερο από :value χαρακτήρες.',
    ],
    'lte' => [
        'array' => 'Το πεδίο :attribute δεν πρέπει να έχει περισσότερα από :value στοιχεία.',
        'file' => 'Το πεδίο :attribute δεν πρέπει να είναι μεγαλύτερο από :value κιλομπάιτ.',
        'numeric' => 'Το πεδίο :attribute δεν πρέπει να είναι μεγαλύτερο από :value.',
        'string' => 'Το πεδίο :attribute δεν πρέπει να είναι μεγαλύτερο από :value χαρακτήρες.',
    ],
    ...
    'missing_with_all' => 'Το πεδίο :attribute πρέπει να λείπει όταν το :values είναι παρόν.',
    ...
    'password' => [
        ...
        'uncompromised' => 'Το δεδομένο :attribute έχει εμφανιστεί σε διαρροή δεδομένων. Παρακαλούμε επιλέξτε άλλο :attribute.',
    ],
    ...
    'present_with_all' => 'Το πεδίο :attribute πρέπει να είναι παρόν όταν τα :values είναι παρόν.',
    ...
    'prohibited_unless' => 'Το πεδίο :attribute είναι απαγορευμένο εκτός αν το :other είναι στα :values.',
    ...
    'required_if_declined' => 'Το πεδίο :attribute είναι υποχρεωτικό όταν το :other απορριφθεί.',
    'required_unless' => 'Το πεδίο :attribute είναι υποχρεωτικό εκτός αν το :other είναι στα :values.',
    'required_with' => 'Το πεδίο :attribute είναι υποχρεωτικό όταν τα :values είναι παρόν.',
    'required_with_all' => 'Το πεδίο :attribute είναι υποχρεωτικό όταν τα :values είναι παρόν.',
    'required_without' => 'Το πεδίο :attribute είναι υποχρεωτικό όταν τα :values δεν είναι παρόν.',
    ...
    'unique' => 'Το :attribute έχει ήδη καταληφθεί.',
