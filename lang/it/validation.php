...
return [
    ...
    | dalla classe di validazione. Alcune di queste regole hanno versioni
    | multiple, come le regole sulle dimensioni. Sentiti libero di
    | personalizzare ciascuno di questi messaggi qui.
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'Il campo :attribute è apparso in una violazione dei dati. Scegli un valore diverso.',
    ],
    ...
    'unique' => 'Il valore per il campo :attribute è già stato utilizzato.',
    ...
    | le righe. Questo permette di definire rapidamente un messaggio
    | specifico per una determinata regola di attributo.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Le seguenti righe servono per sostituire i segnaposto degli attributi
    | con qualcosa di più leggibile, come "Indirizzo E-Mail" al posto di "email".
    | Questo aiuta a rendere il messaggio più espressivo.
    |
    */
