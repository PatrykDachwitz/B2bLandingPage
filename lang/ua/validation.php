...
return [
    ...
    'before_or_equal' => 'Поле :attribute повинно бути датою перед або дорівнювати :date.',
    'between' => [
    ...
    'contains' => 'Поле :attribute не містить потрібне значення.',
    ...
    'doesnt_start_with' => 'Поле :attribute не повинно починатись з одного з наступних: :values.',
    'email' => 'Поле :attribute повинно бути дійсною адресою електронної пошти.',
    'ends_with' => 'Поле :attribute повинно закінчуватись одним із наступних: :values.',
    ...
    'gt' => [
        ...
        'file' => 'Поле :attribute повинно бути більшим ніж :value кілобайтів.',
    ...
    'hex_color' => 'Поле :attribute повинно бути дійсним шестигранним кольором.',
    ...
    'lt' => [
        ...
        'file' => 'Поле :attribute повинно бути меншим ніж :value кілобайтів.',
    ...
    'password' => [
        ...
        'uncompromised' => 'Вказане :attribute з’являлося в витоку даних. Будь ласка, виберіть інше :attribute.',
    ],
    ...
    'starts_with' => 'Поле :attribute повинно починатись з одного з наступних: :values.',
