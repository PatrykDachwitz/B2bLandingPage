...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | تحتوي الأسطر اللغوية التالية على رسائل الخطأ الافتراضية المستخدمة
    ...
    */
    ...
    'ascii' => 'يجب أن يحتوي الحقل :attribute على أحرف وأرقام ذات بايت واحد فقط.',
    ...
    'digits' => 'يجب أن يكون الحقل :attribute :digits أرقامًا.',
    ...
    'min' => [
        ...
        'string' => 'يجب ألا يكون طول الحقل :attribute أقل من :min حرفًا.',
    ],
    ...
    | نمط "attribute.rule" لتسمية السطور.
    |
    */
