    ...
    <div class="col-12 col-lg-5 d-flex flex-column align-items-start text-white">
        ...
        <ul class="list-unstyled fs-6">
            <li>
                ...
                </picture> {!! __($product->work_name . ".ProductionForClient") !!}
            </li>
            <li>
                <picture>
                    <source srcset="/files/icons/check.webp" type="image/webp">
                    <img src="/files/icons/check.png" alt="arrow" loading="lazy" height="20" width="20">
                </picture> {!! __($product->work_name . ".colorAvailable") !!}
            </li>
            @if(!empty(__($product->work_name . ".downloadMaterial")))
                <li>
                    <picture>
                        <source srcset="/files/icons/check.webp" type="image/webp">
                        <img src="/files/icons/check.png" alt="arrow" loading="lazy" height="20" width="20">
                    </picture> <span class="text-white">{!! __($product->work_name . ".downloadMaterial") !!}</span>
                </li>
            @endif
        </ul>
...
<section class="container-1920 overflow-hidden d-flex flex-column mt-2">
    ...
    <div class="artforma-lithebox ai-c jc-c d-none">
        ...
        <div class="artforma-lithebox-content d-f f-c">
            ...
            </div><!--TODO do sprawdzenia czy nic tu do bazy jeszcze nie można przenieśc-->
