...
@section('content')
    ...
    <section class="bg-white d-f f-c jc-s ai-c" style="padding-top: 150px">
        ...
        <h1 class="h1 text-center my-5">@lang('decors.solidline.title')</h1>
        <p class="text-center font18 col-12 col-md-9 col-lg-7 mb-4">@lang('decors.solidline.description')</p>
        <h2 class="h2 text-center my-5">@lang('decors.solidline.titleSupportSectionFirst')</h2>
        ...
        <div class="container row ai-s">
            @php
                ...
                [
                'name' => 'Dąb Nebraska',
                'shortCode' => 'Nebraska- Eiche'
                ],
                [
                'name' => 'Blady Klon',
                'shortCode' => 'Blasser Ahorn'
                ],
                [
                'name' => 'Czarny Dąb',
                'shortCode' => 'Schwarze Eiche'
                ],
                [
                'name' => 'Jasna brzoza',
                'shortCode' => 'Helle Birke'
                ],
                [
                'name' => 'Orzech Włoski',
                'shortCode' => 'Walnuss'
                ...
                [
                'name' => 'Orzech czarny',
                'shortCode' => 'Schwarze Walnuss'
                ],
                [
                'name' => 'Dąb Bielony',
                'shortCode' => 'Gebleichtes Eichenholz'
                ],
                [
                'name' => 'Orzech Amerykański',
                'shortCode' => 'Amerikanische Walnuss'
                ],
                [
                'name' => 'Wenge',
                'shortCode' => 'Wenge'
                ...
                [
                'name' => 'Wiśnia',
                'shortCode' => 'Kirschbaum'
                ],
                [
                'name' => 'Palisander Santos',
                'shortCode' => 'Santos Palisanderholz'
                ],
                [
                'name' => 'Jesion Bielony',
                'shortCode' => 'Esche weiß'
                ],
                [
                'name' => 'Palisander Brazylijski',
                'shortCode' => 'Brasilianisches Palisanderholz'
                ],
                [
                'name' => 'Dąb szary',
                'shortCode' => 'Graue Eiche'
                ],
                [
                'name' => 'Grenheart',
                'shortCode' => 'Grenheart'
                ...
                [
                'name' => 'Świerk',
                'shortCode' => 'Fichtenholz'
                ]
                ];
            @endphp

            @foreach($woodDecors as $color)
                <div class='col-6 col-md-4 col-lg-2 d-f f-c ai-s jc-c mb-2 mb-md-4 pointer' data-galery>
                    <div class='min-width-100'>
                        <picture>
                            <source srcset='/files/Leaflet/colors/wood/{{ str_replace(" ", "-", $color["name"]) }}.webp' type='image/webp'>
                            <img src='/files/Leaflet/colors/wood/{{ str_replace(" ", "-", $color["name"]) }}.jpg' alt='{{ $color["shortCode"] }}' class='min-width-100' loading='lazy'>
                        </picture>
                    </div>
                    <div class='d-f f-c mt-1'><strong class="h3">{{ __("decors.woodDecorNames." . $color["name"]) }}</strong></div>
                </div>
            @endforeach
        </div>
    </section>
