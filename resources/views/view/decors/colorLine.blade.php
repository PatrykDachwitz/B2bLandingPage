...
@section('content')
    ...
    <section class="bg-white d-f f-c jc-s ai-c" style="padding-top: 150px">
        ...
        <h1 class="h1 text-center my-5">@lang('decors.colorline.title')</h1>
        <p class="text-center font18 col-12 col-md-9 col-lg-7 mb-4">@lang('decors.colorline.description')</p>
        <h2 class="h2 text-center my-5">@lang('decors.colorline.titleSupportSectionFirst')</h2>
