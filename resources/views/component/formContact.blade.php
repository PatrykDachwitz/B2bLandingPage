<section class="container-fluid mt-5 pb-5 bg-gray d-flex flex-column align-items-center" id="contactForm">
    ...
    <form class="row formContact g-3" method="POST" action="{{ route('formContact') }}" data-form-contact>
        ...
        <div class="col-12">
            ...
            <div class="invalid-feedback" data-form="names">
            </div>
        </div>
        ...
        <div class="col-12 col-lg-6">
            ...
            <div class="invalid-feedback" data-form="email">
            </div>
        </div>
        <div class="col-12 col-lg-6">
            ...
            <div class="invalid-feedback" data-form="phone"></div>
        </div>
        <div class="col-12">
            ...
            <div class="invalid-feedback" data-form="message">  </div>
        </div>
        ...
        <div class="invalid-feedback col-12" data-form="rule_one"></div>
        ...
        <div class="invalid-feedback col-12" data-form="rule_second"></div>
