<section class="manageCookie d-none" data-hidden-element-name="manageCookie">
    <div class="manageCookie__container d-flex flex-column bg-white p-0 rounded-3">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <picture>
                            ...
                            <img src="/files/icons/arrow.png" data-description-arrow="needCookie" class="pointer ms-2 manageCookie__arrow--down" onclick="showDescription('needCookie')" loading="lazy" width="20" height="20">
                        </picture>
                    </div>
                </div>
            ...
            <div class="d-flex flex-column mt-2">
                <div class="d-flex justify-content-between">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <picture>
                            <source srcset="/files/icons/arrow.webp" type="image/webp">
                            <img src="/files/icons/arrow.png" data-description-arrow="preferenceCookie" class="pointer ms-2 manageCookie__arrow--down" onclick="showDescription('preferenceCookie')" loading="lazy" width="20" height="20">
                        </picture>
                    </div>
                </div>
            ...
            <div class="d-flex flex-column mt-2">
                <div class="d-flex justify-content-between">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <picture>
                            <source srcset="/files/icons/arrow.webp" type="image/webp">
                            <img src="/files/icons/arrow.png" data-description-arrow="statisticCookie" class="pointer ms-2 manageCookie__arrow--down" onclick="showDescription('statisticCookie')" loading="lazy" width="20" height="20">
                        </picture>
                    </div>
                </div>
            ...
            <div class="d-flex flex-column mt-2">
                <div class="d-flex justify-content-between">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <picture>
                            <source srcset="/files/icons/arrow.webp" type="image/webp">
                            <img src="/files/icons/arrow.png" data-description-arrow="marketingCookie" class="pointer ms-2 manageCookie__arrow--down" onclick="showDescription('marketingCookie')" loading="lazy" width="20" height="20">
                        </picture>
                    </div>
                </div>
